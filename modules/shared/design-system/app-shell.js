...
(function () {
  ...
  const MODS = [
    ...
    { g: 'Groei',                  id: 'leadsonderhoud',   naam: 'Leadsonderhoud',    icon: I.repeat,   color: 'teal',    roles: SAMS,tabs: ['Overzicht', 'Contacten', 'Wachtrij', 'Gesprekken', 'Opstartsessies', 'Bronnen', 'Vragenlijst', 'Statistieken'] },
