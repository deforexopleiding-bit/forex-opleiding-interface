...
(function () {
  ...
  const MODS = [
    ...
    { g: 'Klanten & communicatie', id: 'followup',         naam: 'Follow-up',         icon: I.phone,    color: 'violet',  roles: SAMS,      badge: 12, tabs: ['Werklijst', 'Event-bellijst', 'Opvolglijst', 'No-show', 'Retenties', 'Afspraken', 'Kalender', 'Sluimerpot', 'Open-acties', 'Opvolging', 'Statistieken', 'Afgeboekt', 'Archief'] },
