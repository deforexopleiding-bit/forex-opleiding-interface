...
`;
  ...
  function moeiteWoord(m) {
    ...
    // NB: deze functie heeft sinds de omzetting van sectie 5 naar 'Afgehandeld'
    // geen aanroeper meer. De tekst blijft toch conform de regel — moeite is
    // een eigenschap van een mens, pogingen zijn rijen — zodat een toekomstige
    // aanroeper het oude woord niet terugbrengt.
