...
function renderSubCard(sub) {
  ...
  const dealLink = sub.deal_id
    ? `<a class="ds-btn ds-btn-ghost ds-btn-sm" href="/modules/offerte-detail.html?id=${K().esc(encodeURIComponent(sub.deal_id))}" target="_blank" rel="noopener" title="Naar bronoffertte">
