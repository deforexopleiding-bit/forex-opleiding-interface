...
export async function runEngine({ mode = 'cron', abortMs = 50_000, scope = 'production' } = {}) {
  ...
  try {
    result.detected = await detectAndStartRuns(startedAt, abortMs, result.errors, scope, holdStand, stilteStand, irisPauzeStand);
  } catch (e) {
  ...
  try {
    result.runs_advanced = await advanceActiveRuns(startedAt, abortMs, result.errors, scope, holdStand, stilteStand, irisPauzeStand);
  } catch (e) {
...
async function detectAndStartRuns(startedAt, abortMs, errors, scope = 'production', holdStand = null, stilteStand = null, irisPauzeStand = null) {
...
async function advanceActiveRuns(startedAt, abortMs, errors, scope = 'production', holdStand = null, stilteStand = null, irisPauzeStand = null) {
  const now = nowIso();
