...
//   1b. de "neemt een plek in"-regel — her-geëxporteerd uit ./plek-bezet.js
//       (isPlekBezet / applyPlekBezetFilter / heeftVragenlijst)
...
// De plek-regel zelf (isPlekBezet & co) — pure module, zie de her-export hieronder.
import { CONFIRMED_STATUSES, applyPlekBezetFilter } from './plek-bezet.js';
...
// ── "Neemt een plek in" ─────────────────────────────────────────────────────
//
// De regel zelf woont in ./plek-bezet.js — dat bestand heeft met opzet geen
// enkele import, zodat callers die géén Supabase-client willen laden (zoals
// template-variables.js) hem ook kunnen lezen. Hier alleen de her-export,
// zodat elke bestaande import uit event-registration.js blijft werken.
//
//   status IN ('aangemeld','aanwezig') AND is_test = false
//   AND ( assessment_response_id IS NOT NULL
//         OR lower(trim(call_status)) = 'bevestigd' )
//
// SQL-spiegel: public.event_attendee_is_confirmed(text, uuid, boolean, text)
